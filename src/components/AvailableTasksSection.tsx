...
import { MapPin, Plus, User as UserIcon, DollarSign } from 'lucide-react';
...
const AvailableTasksSection: React.FC<AvailableTasksSectionProps> = ({ tasks, loading, error, onViewTaskDetails }) => {
  ...
  return (
    <section id="tasks" className="py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {error && <p className="col-span-full text-center text-red-500 italic py-8">Error loading tasks: {error}</p>}
        {loading && (
