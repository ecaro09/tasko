...
const HowItWorksSection: React.FC = () => {
  ...
  return (
    <section id="how-it-works" className="py-12 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl font-bold text-green-600 mb-10">How Tasko Works</h2>
            ...
            <Card key={index} className="flex flex-col items-center p-6 shadow-md">
              <CardHeader className="p-0 mb-4">
                <div className="w-16 h-16 bg-green-100 dark:bg-green-800 rounded-full flex items-center justify-center mb-4">
                  <step.icon size={32} className="text-green-600 dark:text-green-200" />
                </div>
                <CardTitle className="text-xl font-semibold text-gray-800 dark:text-gray-100">{step.title}</CardTitle>
              </CardHeader>
