...
export interface ChatRoom { // ADDED EXPORT
  id: string;
...
interface ChatContextType {
  messages: Message[];
  chatRooms: ChatRoom[]; // ADDED
  loadingMessages: boolean; // ADDED
  loadingChatRooms: boolean; // ADDED
  error: string | null;
  sendMessage: (chatRoomId: string, recipientId: string, text: string) => Promise<void>;
  ...
  getMessagesForChatRoom: (chatRoomId: string) => (() => void) | undefined; // ADDED
}
...
export const ChatProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const sendMessage = async (chatRoomId: string, recipientId: string, text: string) => {
    if (!isAuthenticated || !user) {
