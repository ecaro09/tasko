...
if (!supabaseUrl || !supabaseAnonKey || supabaseUrl === SUPABASE_URL_PLACEHOLDER || supabaseAnonKey === SUPABASE_ANON_KEY_PLACEHOLDER) {
  const errorMessage = "Supabase URL and/or Anon Key are missing or still using placeholder values. Please update your .env file with the correct Supabase project URL and Anon Key.";
