import { serverTimestamp, FieldValue } from 'firebase/firestore'; // Import FieldValue
import { Task } from '@/lib/task-firestore';
...
// Other optional fields like assignedTaskerId, assignedOfferId, rating, review
// are already part of the base Task interface and are correctly handled as optional.
type InitialTaskData = Omit<Task, 'id' | 'datePosted'> & { // Omit 'datePosted' from Task
  datePosted: FieldValue; // Now explicitly FieldValue for initial data
};
...
export const initialTasks: InitialTaskData[] = [
  ...
  },
  {
    ...
    category: "other", // Changed to 'other' as 'gardening' is not in the select options
