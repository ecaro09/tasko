  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 pt-[80px]">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <h1 className="text-4xl font-bold text-green-600 mb-8 text-center">Privacy Policy</h1>
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md prose dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tasko Philippines.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Tasko, accessible from <a href="https://www.dyad.sh" target="_blank" rel="noopener noreferrer">https://www.dyad.sh</a>
            </li>
            <li>
          ...
          <ul>
            <li>By email: support@tasko.ph</li>
            <li>By visiting this page on our website: <a href="https://www.dyad.sh/contact" target="_blank" rel="noopener noreferrer">https://www.dyad.sh/contact</a></li>
          </ul>
        </div>
      </div>
    </div>
