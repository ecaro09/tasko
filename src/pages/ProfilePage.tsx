...
import { User as UserIcon, Mail, Edit } from 'lucide-react'; // Import Edit icon
import EditProfileSection from '@/components/EditProfileSection'; // Import the new component
